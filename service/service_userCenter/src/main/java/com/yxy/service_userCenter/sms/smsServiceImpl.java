...
public class smsServiceImpl implements smsService{
    ...
    static final String accessKeyId = "LTAI4GHLQiLSJML3QaCs9Ro2";
    static final String accessKeySecret = "cGtMqZZDVSET7QHjmfWhAXLB8gJLE0";
    ...
    public boolean sendSms(String phone, String code) throws ClientException {
        ...
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_205462000");
